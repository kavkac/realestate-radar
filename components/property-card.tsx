          ...
          {isSignedIn && (
            <section className="mt-6 pt-5 border-t border-gray-100">
              <div className="flex items-baseline justify-between mb-2">
                <p className="text-[11px] uppercase tracking-wide text-gray-400 font-medium">Cenovni heatmap</p>
                <p className="text-[10px] text-gray-400">ETN transakcije · GURS</p>
              </div>
              <PriceHeatmapMap height="360px" centerLat={lat ?? undefined} centerLng={lng ?? undefined} />
            </section>
          )}
        </div>
